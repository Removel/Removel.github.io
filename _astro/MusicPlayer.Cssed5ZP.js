import{o as Ct,a as St,p as Z,b as F,f as Ht,s as B,c as Tt}from"./disclose-version.4cufAerw.js";import{i as Bt}from"./legacy.ByQMFyZG.js";import{v as At,E as Ft,bl as Nt,bm as Kt,i as jt,u as Xt,bn as Ot,bo as Ut,a3 as Wt,bk as nt,bp as Et,c as tt,ai as pt,p as qt,d,g as o,e as w,r as c,a as P,b as et,s as bt,f as T,aa as ot,ab as $,t as R,ac as Y,ad as D,ap as gt,m as Yt,ae as Gt,bq as Jt,aq as Qt,U as mt}from"./utils.2G6l_Cro.js";import{a as Zt,s as O}from"./render.e2T5r9VE.js";import{i as A}from"./if.tu4caGbx.js";import{I as V}from"./Icon.BUZnyDo6.js";import{m as ft}from"./config.CCCnRNXN.js";import{m as _}from"./musicPlayerStore.8ChkroDE.js";import{S as $t,a as te,b as ee,c as re,d as ie,C as yt,P as ne,e as ae,N as oe}from"./SidebarTrackInfo.BPG7ktx1.js";import{I as J}from"./zh_TW.CABTBg9K.js";import{i as Q}from"./translation.CotsaaLf.js";import{s as le}from"./snippet.CdGhp-r8.js";import{a as se}from"./actions.DETXSa3r.js";import{e as ue,i as ce}from"./each.eute74AM.js";const de=()=>performance.now(),q={tick:r=>requestAnimationFrame(r),now:()=>de(),tasks:new Set};function Mt(){const r=q.now();q.tasks.forEach(t=>{t.c(r)||(q.tasks.delete(t),t.f())}),q.tasks.size!==0&&q.tick(Mt)}function ge(r){let t;return q.tasks.size===0&&q.tick(Mt),{promise:new Promise(e=>{q.tasks.add(t={c:r,f:e})}),abort(){q.tasks.delete(t)}}}function dt(r,t){Et(()=>{r.dispatchEvent(new CustomEvent(t))})}function ve(r){if(r==="float")return"cssFloat";if(r==="offset")return"cssOffset";if(r.startsWith("--"))return r;const t=r.split("-");return t.length===1?t[0]:t[0]+t.slice(1).map(e=>e[0].toUpperCase()+e.slice(1)).join("")}function wt(r){const t={},e=r.split(";");for(const s of e){const[a,l]=s.split(":");if(!a||l===void 0)break;const m=ve(a.trim());t[m]=l.trim()}return t}const me=r=>r;function Lt(r,t,e,s){var a=(r&Ot)!==0,l="both",m,g=t.inert,p=t.style.overflow,i,u;function v(){return Et(()=>m??=e()(t,s?.()??{},{direction:l}))}var f={is_global:a,in(){t.inert=g,i=ht(t,v(),u,1,()=>{dt(t,"introend"),i?.abort(),i=m=void 0,t.style.overflow=p})},out(S){t.inert=!0,u=ht(t,v(),i,0,()=>{dt(t,"outroend"),S?.()})},stop:()=>{i?.abort(),u?.abort()}},b=At;if((b.nodes.t??=[]).push(f),Zt){var x=a;if(!x){for(var n=b.parent;n&&(n.f&Ft)!==0;)for(;(n=n.parent)&&(n.f&Nt)===0;);x=!n||(n.f&Kt)!==0}x&&jt(()=>{Xt(()=>f.in())})}}function ht(r,t,e,s,a){var l=s===1;if(Ut(t)){var m,g=!1;return Wt(()=>{if(!g){var S=t({direction:l?"in":"out"});m=ht(r,S,e,s,a)}}),{abort:()=>{g=!0,m?.abort()},deactivate:()=>m.deactivate(),reset:()=>m.reset(),t:()=>m.t()}}if(e?.deactivate(),!t?.duration&&!t?.delay)return dt(r,l?"introstart":"outrostart"),a(),{abort:nt,deactivate:nt,reset:nt,t:()=>s};const{delay:p=0,css:i,tick:u,easing:v=me}=t;var f=[];if(l&&e===void 0&&(u&&u(0,1),i)){var b=wt(i(0,1));f.push(b,b)}var x=()=>1-s,n=r.animate(f,{duration:p,fill:"forwards"});return n.onfinish=()=>{n.cancel(),dt(r,l?"introstart":"outrostart");var S=e?.t()??1-s;e?.abort();var h=s-S,I=t.duration*Math.abs(h),C=[];if(I>0){var y=!1;if(i)for(var E=Math.ceil(I/16.666666666666668),z=0;z<=E;z+=1){var rt=S+h*v(z/E),lt=wt(i(rt,1-rt));C.push(lt),y||=lt.overflow==="hidden"}y&&(r.style.overflow="hidden"),x=()=>{var it=n.currentTime;return S+h*v(it/I)},u&&ge(()=>{if(n.playState!=="running")return!1;var it=x();return u(it,1-it),!0})}n=r.animate(C,{duration:I,fill:"forwards"}),n.onfinish=()=>{x=()=>s,u?.(s,1-s),a()}},{abort:()=>{n&&(n.cancel(),n.effect=null,n.onfinish=nt)},deactivate:()=>{a=nt},reset:()=>{s===0&&u?.(1,0)},t:()=>x()}}function fe(r){const t=r-1;return t*t*t+1}function It(r){const t=r-1;return t*t*t+1}function kt(r){const t=typeof r=="string"&&r.match(/^\s*(-?[\d.]+)([^\s]*)\s*$/);return t?[parseFloat(t[1]),t[2]||"px"]:[r,"px"]}function be(r,{delay:t=0,duration:e=400,easing:s=It,x:a=0,y:l=0,opacity:m=0}={}){const g=getComputedStyle(r),p=+g.opacity,i=g.transform==="none"?"":g.transform,u=p*(1-m),[v,f]=kt(a),[b,x]=kt(l);return{delay:t,duration:e,easing:s,css:(n,S)=>`
		...
		:global(button.bg-\\\\[var\\\\(--primary\\\\)\\\\]) {
			...
			border: none;
		}</style>`,1);function fr(r,t){tt(t,!1);let e=Yt(_.getState());const s=ft.showFloatingPlayer,l=(ft.floatingEntryMode??"default")==="fab",m=s&&ft.enable;let g;function p(){_.toggle()}function i(){_.prev()}function u(){_.next()}function v(){_.toggleShuffle()}function f(){_.toggleRepeat()}function b(k){_.playIndex(k)}function x(k){const M=k.currentTarget;if(!M)return;const U=M.getBoundingClientRect(),j=(k.clientX-U.left)/U.width;_.setProgress(j)}function n(k){(k.key==="Enter"||k.key===" ")&&(k.preventDefault(),_.setProgress(.5))}function S(){_.toggleMute()}function h(){_.toggleMute()}function I(k){const M=k.currentTarget;if(!M)return;const U=L=>{const N=M.getBoundingClientRect();if(N.width<=0)return;const K=Math.max(0,Math.min(1,(L-N.left)/N.width));_.setVolume(K)};U(k.clientX);const j=k.pointerId;M.setPointerCapture(j);const st=L=>{L.pointerId===j&&U(L.clientX)},ut=()=>{M.removeEventListener("pointermove",st),M.removeEventListener("pointerup",ct),M.removeEventListener("pointercancel",H),M.hasPointerCapture(j)&&M.releasePointerCapture(j)},ct=L=>{L.pointerId===j&&(U(L.clientX),ut())},H=L=>{L.pointerId===j&&ut()};M.addEventListener("pointermove",st),M.addEventListener("pointerup",ct),M.addEventListener("pointercancel",H)}function C(k){const M=k.target;if(!(M?.tagName==="INPUT"||M?.tagName==="TEXTAREA"||M?.contentEditable==="true")){if(k.key==="ArrowLeft"||k.key==="ArrowDown"){k.preventDefault(),_.setVolume(o(e).volume-.05);return}if(k.key==="ArrowRight"||k.key==="ArrowUp"){k.preventDefault(),_.setVolume(o(e).volume+.05);return}(k.key==="Enter"||k.key===" "||k.key==="m"||k.key==="M")&&(k.preventDefault(),S())}}function y(){_.togglePlaylist()}function E(){_.toggleExpanded()}function z(){_.toggleHidden()}function rt(){_.hideError()}function lt(k){}function it(){return _.canSkip()}Ct(()=>{g=_.subscribe(k=>{bt(e,k)}),_.initialize()}),St(()=>{g&&g(),_.destroy()}),Bt();var xt=ot();Gt("keydown",Jt,C);var Dt=$(xt);{var Rt=k=>{var M=tr(),U=$(M);{var j=H=>{var L=Qe(),N=d(L),K=d(N);V(K,{icon:"material-symbols:error",class:"text-xl flex-shrink-0"});var W=w(K,2),G=d(W,!0);c(W);var X=w(W,2),at=d(X);V(at,{icon:"material-symbols:close",class:"text-lg"}),c(X),c(N),c(L),R(()=>O(G,o(e).errorMessage)),D("click",X,rt),P(H,L)};A(U,H=>{o(e).showError&&H(j)})}var st=w(U,2);{var ut=H=>{var L=ot(),N=$(L);{var K=W=>{var G=Ze(),X=d(G),at=d(X);xe(at,{}),c(X),c(G),Lt(3,X,()=>be,()=>({y:16,duration:280,opacity:.12,easing:fe})),P(W,G)};A(N,W=>{o(e).isExpanded&&W(K)})}P(H,L)},ct=H=>{var L=$e();let N;var K=d(L),W=d(K);yt(W,{get cover(){return o(e).currentSong.cover},get isPlaying(){return o(e).isPlaying},get isLoading(){return o(e).isLoading},size:"orb",onclick:z}),c(K);var G=w(K,2);{let vt=mt(()=>o(e).isExpanded||o(e).isHidden);Ee(G,{get song(){return o(e).currentSong},get currentTime(){return o(e).currentTime},get duration(){return o(e).duration},get isPlaying(){return o(e).isPlaying},get isLoading(){return o(e).isLoading},get isHidden(){return o(vt)},onCoverClick:p,onInfoClick:E,onHideClick:z,onExpandClick:E})}var X=w(G,2);{let vt=mt(it),Vt=mt(()=>!o(e).isExpanded);Ue(X,{get song(){return o(e).currentSong},get currentTime(){return o(e).currentTime},get duration(){return o(e).duration},get isPlaying(){return o(e).isPlaying},get isLoading(){return o(e).isLoading},get isShuffled(){return o(e).isShuffled},get isRepeating(){return o(e).isRepeating},get showPlaylist(){return o(e).showPlaylist},get canSkip(){return o(vt)},get volume(){return o(e).volume},get isMuted(){return o(e).isMuted},isVolumeDragging:!1,get isHidden(){return o(Vt)},volumeBarRef:lt,onPlayClick:p,onPrevClick:i,onNextClick:()=>u(),onShuffleClick:v,onRepeatClick:f,onProgressClick:x,onProgressKeyDown:n,onVolumeButtonClick:h,onSliderPointerDown:I,onSliderKeyDown:C,onHideClick:z,onPlaylistClick:y,onCollapseClick:E})}var at=w(X,2);Je(at,{get playlist(){return o(e).playlist},get currentIndex(){return o(e).currentIndex},get isPlaying(){return o(e).isPlaying},get show(){return o(e).showPlaylist},onClose:y,onPlaySong:b}),c(L),R(()=>{N=F(L,1,"music-player fixed bottom-4 right-4 z-50 transition-all duration-300 ease-in-out",null,N,{expanded:o(e).isExpanded,"hidden-mode":o(e).isHidden}),F(K,1,`orb-player-container ${o(e).isHidden?"orb-enter pointer-events-auto":"orb-leave pointer-events-none"}`)}),P(H,L)};A(st,H=>{l?H(ut):H(ct,-1)})}Qt(2),P(k,M)};A(Dt,k=>{m&&k(Rt)})}P(r,xt),et()}Y(["click"]);export{fr as default};
