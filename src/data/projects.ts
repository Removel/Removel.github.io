...
export const projectsData: Project[] = [
	...
	{
		id: "one-and-only",
		title: "One And Only 虚拟助手",
		description:
			"一个完整的AI虚拟助手项目，结合了前后端技术与Live2D虚拟形象，实现了智能长期记忆对话、实时眼部跟随、多会话管理、背景切换等丰富功能，提供沉浸式的交互体验。",
		image: "/assets/projects/OneAndOnlyDemo.png",
		category: "web",
		techStack: [
			"Vue 3",
			"TypeScript",
		...
		status: "in-progress",
		sourceCode: "https://github.com/Removel/OneAndOnly.git",
